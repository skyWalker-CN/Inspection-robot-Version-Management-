...
class OllamaChatNode(Node):
    def __init__(self):
        ...
        self.answer_publisher = self.create_publisher(
            String, 
            '/getMSG', 
            10
        )
    ...
    def message_callback(self, msg):
        ...
        try:
            ...
            response_content = self.extract_content(response_content)
            answer_msg = String()
            answer_msg.data = response_content
